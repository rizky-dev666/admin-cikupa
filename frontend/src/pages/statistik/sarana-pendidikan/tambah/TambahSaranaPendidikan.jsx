...
const TambahSaranaPendidikan = () => {
  ...
  const handleSubmitSaranaPendidikan = async (e) => {
    e.preventDefault();
    try {
      await axios.post("/api/data-sarana-pendidikan", dataSaranaPendidikan);
      alert("Data sarana pendidikan berhasil dikirim!");
      navigate("/statistik/sarana-pendidikan");
    } catch (error) {
      alert("Gagal kirim data sarana pendidikan");
      console.error(error);
    }
  };
  ...
  return (
    <div style={{ padding: 20 }}>
      <h2>Form Data sarana Pendidikan</h2>
...
export default TambahSaranaPendidikan;

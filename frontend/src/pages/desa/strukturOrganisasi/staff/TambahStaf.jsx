  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (foto) {
        ...
        const uploadRes = await axios.post("/api/upload/struktur-organisasi", form);
      ...
      await axios.post("/api/struktur-organisasi/staff", dataToSend);
  ...
  return (
    <div className="flex justify-center min-h-screen  p-4">
      <div className="bg-white  rounded-lg p-6 w-full max-w-4xl">
        <h2 className="text-2xl font-bold mb-6 text-gray-700 text-center">Tambah Staff</h2>

        <form onSubmit={handleSubmit} encType="multipart/form-data">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col items-center">
              <label className="w-full text-center font-semibold mb-2">Foto Staff</label>
          ...
          >
            {isUploading ? "Mengunggah..." : "Simpan staff"}
          </button>
        </form>
      </div>
    </div>
